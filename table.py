...
class Data_Cell(Cell):
    def __init__(self, master, variable, anchor=W, bordercolor='blue', borderwidth=1, padx=0, pady=0, background=None, foreground=None, font=None):
...
##
##
##    table = Table(right_frame, ["MONDAY", "TUESDAY", "WEDNESDAY",'THURSDAY','FRIDAY'], column_minwidths=[None, None, None])
